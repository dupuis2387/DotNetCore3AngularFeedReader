    ...
    public partial class InitialRedo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    FeedId = table.Column<int>(nullable: false),
                    UserSubscriberId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedUserSubscriptions", x => new { x.UserSubscriberId, x.FeedId });
                    table.ForeignKey(
                        name: "FK_FeedUserSubscriptions_Feeds_FeedId",
                        column: x => x.FeedId,
                        principalTable: "Feeds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeedUserSubscriptions_AspNetUsers_UserSubscriberId",
